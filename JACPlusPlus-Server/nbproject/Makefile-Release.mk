...
${OBJECTDIR}/packet/LoginPacket.o: packet/LoginPacket.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/packet/LoginPacket.o packet/LoginPacket.cpp

${OBJECTDIR}/packet/NameSetPacket.o: packet/NameSetPacket.cpp 
	${MKDIR} -p ${OBJECTDIR}/packet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/packet/NameSetPacket.o packet/NameSetPacket.cpp
...
${OBJECTDIR}/packet/PacketFactory.o: packet/PacketFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/packet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/packet/PacketFactory.o packet/PacketFactory.cpp

${OBJECTDIR}/packet/PacketHandler.o: packet/PacketHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/packet
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/packet/PacketHandler.o packet/PacketHandler.cpp
